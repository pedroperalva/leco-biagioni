...
export default function Dicas() {
  ...
  return (
    <main className="min-h-screen w-full px-4 pb-[200px] text-black space-y-12 pt-[100px]">
      <div className="w-full relative flex items-center flex-col justify-center">
        ...
        <div className="md:w-2xl w-full space-y-6 my-10 pt-8 font-bold text-black relative">
